...
class Quiz_Maker_Admin
{
    ...
    */
    ...
    public function ays_quiz_sale_baner(){
        if(isset($_POST['ays_quiz_sale_spring_btn'])){
            update_option('ays_quiz_sale_spring_btn', 1); 
            update_option('ays_quiz_sale_date', current_time( 'mysql' ));
        }

        if(isset($_POST['ays_quiz_sale_spring_btn_for_two_months'])){
            update_option('ays_quiz_sale_spring_btn_for_two_months', 1);
            update_option('ays_quiz_sale_date', current_time( 'mysql' ));
        }

        $ays_quiz_sale_date = get_option('ays_quiz_sale_date');
        $ays_quiz_sale_two_months = get_option('ays_quiz_sale_spring_btn_for_two_months');
        ...
        if(intval($days_diff) > 0 ){
            update_option('ays_quiz_sale_spring_btn', 0); 
            update_option('ays_quiz_sale_spring_btn_for_two_months', 0);
        }

        $ays_quiz_ishmar = intval(get_option('ays_quiz_sale_spring_btn'));
        $ays_quiz_ishmar += intval(get_option('ays_quiz_sale_spring_btn_for_two_months'));
